   ...
   switch(CR1_ucMainTimerCaseCore1)  //full switch run through is 0.25mS
   {
      ...
      if(btRun)
      {
       ...
       {   
         ...
         switch(ucMotorStateIndex)
         {
          ...
          case 2:
          {
            ENC_SetDistance(27, -27); //go left a bit
            ucMotorState = 2; //left
            CR1_ui8LeftWheelSpeed = CR1_ui8WheelSpeed;
            CR1_ui8RightWheelSpeed = CR1_ui8WheelSpeed;
            ucMotorStateIndex = 3;
          ...
          case 4:
          {
            ENC_SetDistance(-27, 27); //go right a bit
          ...
          ledcWrite(4,255);
          ledcWrite(3,255);
              CR1_ciMotorRunTime = 4000; //set the time allocated for each case to 2 sec
             raiseFlag = true;
    ...
    case 3: 
    {
      ...
      if(ENC_ISMotorRunning())
      {
        ...
        MoveTo(ucMotorState, LeftAdjust(CR1_ui8LeftWheelSpeed, CR1_ui8Adjuster)-6, RightAdjust(CR1_ui8RightWheelSpeed, CR1_ui8Adjuster)+32);
      }
